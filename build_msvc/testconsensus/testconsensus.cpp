...
// reptiloidscoin includes.
#include <..\src\script\reptiloidscoinconsensus.h>
...
int main()
{
    std::cout << "reptiloidscoinconsensus version: " << reptiloidscoinconsensus_version() << std::endl;
    ...
    auto op0Result = reptiloidscoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, reptiloidscoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
