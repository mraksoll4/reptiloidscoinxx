...
# TestP2PConn: A peer we use to send messages to reptiloidscoind, and store responses.
...
class CompactBlocksTest(ReptiloidsCoinTestFramework):
    ...
    # This test actually causes reptiloidscoind to (reasonably!) disconnect us, so do this last.
    ...
    # reptiloidscoind's choice of nonce.
    ...
    # Test that reptiloidscoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for reptiloidscoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # reptiloidscoind will not send blocktxn responses for blocks whose height is
