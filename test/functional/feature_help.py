...
"""Verify that starting reptiloidscoin with -h works as expected."""

from test_framework.test_framework import ReptiloidsCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(ReptiloidsCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start reptiloidscoin with -h for help text")
        ...
        self.log.info("Start reptiloidscoin with -version for version information")
        ...
        self.log.info("Start reptiloidscoind with -fakearg to make sure it does not start")
