...
class InvalidMessagesTest(ReptiloidsCoinTestFramework):
    ...
    def run_test(self):
        ...
        if [s for s in os.environ.get("REPTILOIDSCOIN_CONFIG", "").split(" ") if "--with-sanitizers" in s and "address" in s]:
