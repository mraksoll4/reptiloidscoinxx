...
This document provides guidelines for internationalization of the ReptiloidsCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `reptiloidscoin_en.ts` remains unchanged.
