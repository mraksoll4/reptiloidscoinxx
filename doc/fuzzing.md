Fuzz-testing ReptiloidsCoin Core
==========================
...
```
git clone https://github.com/reptiloidscoin-core/qa-assets
...
To build ReptiloidsCoin Core using AFL instrumentation (this assumes that the
