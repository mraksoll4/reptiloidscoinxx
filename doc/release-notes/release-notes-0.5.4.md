ReptiloidsCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/reptiloidscoin/files/ReptiloidsCoin/reptiloidscoin-0.5.4/
...
http://gitorious.org/reptiloidscoin/reptiloidscoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix ReptiloidsCoin-Qt notifications under Growl 1.3.
Increase required age of ReptiloidsCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxReptiloidsCoin properly when installing ReptiloidsCoin-Qt over it. (Windows)
