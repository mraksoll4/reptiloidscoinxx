ReptiloidsCoin Core version 0.9.1 is now available from:

  https://reptiloidscoin.org/bin/0.9.1/
...
reptiloidscoind from any pre-0.9.1 version, and have enabled SSL for RPC and
...
- Upgrade OpenSSL to 1.0.1g. This release fixes the following vulnerabilities which can
  affect the ReptiloidsCoin Core software:
