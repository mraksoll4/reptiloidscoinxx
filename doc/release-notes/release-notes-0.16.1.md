ReptiloidsCoin Core version 0.16.1 is now available from:

  <https://reptiloidscoincore.org/bin/reptiloidscoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting reptiloidscoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure reptiloidscoind processes are cleaned up when tests end (sdaftuar)
