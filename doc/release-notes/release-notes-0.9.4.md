ReptiloidsCoin Core version 0.9.4 is now available from:

  https://reptiloidscoin.org/bin/0.9.4/
...
this update is incompatible with the ReptiloidsCoin system and could lead to consensus
forks.

ReptiloidsCoin Core released binaries from https://reptiloidscoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~reptiloidscoin/+archive/ubuntu/reptiloidscoin
- A third-party or self-compiled ReptiloidsCoin Core

upgrade to ReptiloidsCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
