ReptiloidsCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/reptiloidscoin/files/ReptiloidsCoin/reptiloidscoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the ReptiloidsCoin
...
New/changed settings (command-line or reptiloidscoin.conf file)
--------------------------------------------------------
