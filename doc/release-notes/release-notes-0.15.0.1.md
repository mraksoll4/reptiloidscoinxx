ReptiloidsCoin Core version *0.15.0.1* is now available from:

  <https://reptiloidscoin.org/bin/reptiloidscoin-core-0.15.0.1/>

and

  <https://reptiloidscoincore.org/bin/reptiloidscoin-core-0.15.0.1/>
