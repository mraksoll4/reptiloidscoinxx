Download URL: https://sourceforge.net/projects/reptiloidscoin/files/ReptiloidsCoin/reptiloidscoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 RTD fee schedule (users still pay 0.01 RTD per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #reptiloidscoin00 - #reptiloidscoin99
