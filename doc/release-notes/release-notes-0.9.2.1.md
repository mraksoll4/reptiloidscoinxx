ReptiloidsCoin Core version 0.9.2.1 is now available from:

  https://reptiloidscoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 RTD to 0.01 RTD
...
- Fix "Start reptiloidscoin on system login"
