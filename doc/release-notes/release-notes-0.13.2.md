ReptiloidsCoin Core version 0.13.2 is now available from:

  <https://reptiloidscoin.org/bin/reptiloidscoin-core-0.13.2/>
...
- #8908 `4a974b2` Update reptiloidscoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow reptiloidscoin-tx to create v2 transactions (btcdrak)
