...
#ifndef REPTILOIDSCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define REPTILOIDSCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // REPTILOIDSCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
