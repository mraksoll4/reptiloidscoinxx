...
{
    // Call into TxToUniv() in reptiloidscoin-common to decode the transaction hex.
    //
    // Blockchain contextual information (confirmations and blocktime) is not
    // available to code in reptiloidscoin-common, so we query them here and push the
