...
#ifndef REPTILOIDSCOIN_INTERFACES_NODE_H
#define REPTILOIDSCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a reptiloidscoin node (reptiloidscoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // REPTILOIDSCOIN_INTERFACES_NODE_H
