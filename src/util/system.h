 ...
 */
#ifndef REPTILOIDSCOIN_UTIL_SYSTEM_H
#define REPTILOIDSCOIN_UTIL_SYSTEM_H
...
extern const char * const REPTILOIDSCOIN_CONF_FILENAME;
...
#endif // REPTILOIDSCOIN_UTIL_SYSTEM_H
