...
#ifndef REPTILOIDSCOIN_WALLET_WALLET_H
#define REPTILOIDSCOIN_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! reptiloidscoin from opening the wallet, thinking it was newly created, and
...
public:
     ...
     * on this reptiloidscoin node, and set to 0 for transactions that were created
...
#endif // REPTILOIDSCOIN_WALLET_WALLET_H
