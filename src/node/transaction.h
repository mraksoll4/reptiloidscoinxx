// Copyright (c) 2017-2019 The ReptiloidsCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef REPTILOIDSCOIN_NODE_TRANSACTION_H
#define REPTILOIDSCOIN_NODE_TRANSACTION_H
...
#endif // REPTILOIDSCOIN_NODE_TRANSACTION_H
