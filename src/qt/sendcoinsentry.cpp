    ...
    platformStyle(_platformStyle)
{
    ...
    // normal reptiloidscoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying reptiloidscoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &ReptiloidsCoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
