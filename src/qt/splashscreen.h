...
#ifndef REPTILOIDSCOIN_QT_SPLASHSCREEN_H
#define REPTILOIDSCOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. ReptiloidsCoin Core initialization
...
#endif // REPTILOIDSCOIN_QT_SPLASHSCREEN_H
