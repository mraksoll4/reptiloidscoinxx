    ...
    mapper(nullptr)
{
    ...
    ui->reptiloidscoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->reptiloidscoinAtStartup);
    ...
    ui->reptiloidscoinAtStartup->setToolTip(ui->reptiloidscoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->reptiloidscoinAtStartup->setText(ui->reptiloidscoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openReptiloidsCoinConfButton->setToolTip(ui->openReptiloidsCoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new ReptiloidsCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->reptiloidscoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openReptiloidsCoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openReptiloidsCoinConf())
