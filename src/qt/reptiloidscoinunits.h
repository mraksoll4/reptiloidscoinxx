...
#ifndef REPTILOIDSCOIN_QT_REPTILOIDSCOINUNITS_H
#define REPTILOIDSCOIN_QT_REPTILOIDSCOINUNITS_H
...
/** ReptiloidsCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ReptiloidsCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ReptiloidsCoinUnits(QObject *parent);

    /** ReptiloidsCoin units.
      @note Source: https://en.reptiloidscoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        RTD,
...
typedef ReptiloidsCoinUnits::Unit ReptiloidsCoinUnit;

#endif // REPTILOIDSCOIN_QT_REPTILOIDSCOINUNITS_H
