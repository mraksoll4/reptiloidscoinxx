...
//! Entry point for ReptiloidsCoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &ReptiloidsCoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for ReptiloidsCoinGUI tests.
void AppTests::guiTests(ReptiloidsCoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &ReptiloidsCoinGUI::consoleShown, this, &AppTests::consoleTests);
