...
#ifndef REPTILOIDSCOIN_QT_SENDCOINSDIALOG_H
#define REPTILOIDSCOIN_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending reptiloidscoins */
...
#endif // REPTILOIDSCOIN_QT_SENDCOINSDIALOG_H
