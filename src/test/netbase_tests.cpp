...
{
    BOOST_CHECK(TestSplitHost("www.reptiloidscoincore.org", "www.reptiloidscoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.reptiloidscoincore.org]", "www.reptiloidscoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.reptiloidscoincore.org:80", "www.reptiloidscoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.reptiloidscoincore.org]:80", "www.reptiloidscoincore.org", 80));
