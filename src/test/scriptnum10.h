...
#ifndef REPTILOIDSCOIN_TEST_SCRIPTNUM10_H
#define REPTILOIDSCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from ReptiloidsCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // REPTILOIDSCOIN_TEST_BIGNUM_H
