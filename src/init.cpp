 ...
 */
static const char* REPTILOIDSCOIN_PID_FILENAME = "reptiloidscoind.pid";

static fs::path GetPidFile()
{
    return AbsPathForConfigVal(fs::path(gArgs.GetArg("-pid", REPTILOIDSCOIN_PID_FILENAME)));
}
 ...
 * between reptiloidscoind, and reptiloidscoin-qt and non-server tools.
*/
...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-conf=<file>", strprintf("Specify configuration file. Relative paths will be prefixed by datadir location. (default: %s)", REPTILOIDSCOIN_CONF_FILENAME), false, OptionsCategory::OPTIONS);
    ...
    gArgs.AddArg("-pid=<file>", strprintf("Specify pid file. Relative paths will be prefixed by a net-specific datadir location. (default: %s)", REPTILOIDSCOIN_PID_FILENAME), false, OptionsCategory::OPTIONS);
...
std::string LicenseInfo()
{
    ...
    const std::string URL_WEBSITE = "<https://reptiloidscoincore.org>";
...
/** Sanity checks
 *  Ensure that ReptiloidsCoin is running in a usable environment with all
...
{
    // Make sure only a single ReptiloidsCoin process is using the data directory.
...
bool AppInitMain(InitInterfaces& interfaces)
{
    ...
    fs::path config_file_path = GetConfigFile(gArgs.GetArg("-conf", REPTILOIDSCOIN_CONF_FILENAME));
